package com.ideahunters.customwidgets.MaterialBetterSpinner;
...
import com.ideahunters.customwidgets.MaterialBetterSpinner.materialedittext.MaterialAutoCompleteTextView;
...
public class MaterialBetterSpinner extends MaterialAutoCompleteTextView implements AdapterView.OnItemClickListener {
    ...
    public void setHelperTextColor(int color) {
        super.setHelperTextColor(color);
    }
}
