...
public class IdeaDeletePresenter implements Constants {
    private final Context context;
    private final IdeaDeletePresenterListener mListener;
    private final ApiClient apiClient;
    private String device_type, status;
    private String image_name;
    private String file;

    public interface IdeaDeletePresenterListener {
    ...
    public IdeaDeletePresenter(IdeaDeletePresenterListener listener, Context context) {
    ...
    public void deleteIdea(String sug_id) {

            Singleton.getInstance().showProgressDialog(context);
            apiClient
                    .createService(BASE_URL)
                    .deleteIdea(Singleton.getInstance().getValue(context, USER_ID),sug_id)
